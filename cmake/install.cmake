...
install(TARGETS ${PACKAGE} PERMISSIONS OWNER_EXECUTE OWNER_WRITE OWNER_READ DESTINATION ${BIN_FILE_DEST})
install(FILES ${DOC_FILES} DESTINATION ${DOC_FILES_DEST})
install(DIRECTORY ${WEBUI_DIR} DESTINATION ${WEBUI_DIR_DEST})

if(NOT EXISTS ${CONF_FILE_DEST}/nzbget.conf)
	...
	message(STATUS "${CONF_FILE_DEST}/nzbget.conf already exists")
endif()
