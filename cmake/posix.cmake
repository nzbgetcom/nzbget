...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
	option(ENABLE_IO_URING "Enable io_uring as default reactor (requires liburing, kernel 5.10+)" OFF)
endif()
...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
message(STATUS "  ENABLE IO_URING:   ${ENABLE_IO_URING}")
endif()
	...
	if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
		if(ENABLE_IO_URING)
			...
			if(LIBURING_INCLUDE_DIR AND LIBURING_LIBRARY)
				...
				set(LIBS ${LIBS} ${LIBURING_LIBRARY})
				set(INCLUDES ${INCLUDES} ${LIBURING_INCLUDE_DIR})
				message(STATUS "  IO_URING: enabled (default reactor)")
			else()
				message(FATAL_ERROR "ENABLE_IO_URING requires liburing. Install liburing-dev.")
			endif()
		endif()
	endif()
endif()
