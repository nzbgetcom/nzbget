...
Docker images are available for x86-64 / arm64 / armv7 architectures. [Docker readme](docker/README.md). LinuxServer.io version also available: [docker-nzbget](https://github.com/linuxserver/docker-nzbget)
