...
static struct option long_options[] =
	{
		...
		{"noconfigfile", no_argument, NULL, 'n'},
		{"printconfig", no_argument, NULL, 'p'},
		{"server", no_argument, NULL, 's' },
		{"daemon", no_argument, NULL, 'D' },
		{"version", no_argument, NULL, 'v'},
		{"serverversion", no_argument, NULL, 'V'},
		{"option", required_argument, NULL, 'o'},
		{"append", no_argument, NULL, 'A'},
		{"list", no_argument, NULL, 'L'},
		{"pause", no_argument, NULL, 'P'},
		{"unpause", no_argument, NULL, 'U'},
		{"rate", required_argument, NULL, 'R'},
		{"system", no_argument, NULL, 'B'},
		{"log", required_argument, NULL, 'G'},
		{"top", no_argument, NULL, 'T'},
		{"edit", required_argument, NULL, 'E'},
		{"connect", no_argument, NULL, 'C'},
		{"quit", no_argument, NULL, 'Q'},
		{"reload", no_argument, NULL, 'O'},
		{"write", required_argument, NULL, 'W'},
		{"category", required_argument, NULL, 'K'},
